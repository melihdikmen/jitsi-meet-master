...
import {
    ...
    UPDATE_KNOWN_LARGE_VIDEO_RESOLUTION, UPDATE_LAST_LARGE_VIDEO_MEDIA_EVENT,SET_SELECTED_PARTICIPANT_INDEX
} from './actionTypes';

ReducerRegistry.register('features/large-video', (state = {selectedParticipantIndex:0}, action) => {
    switch (action.type) {
    ...
    case UPDATE_LAST_LARGE_VIDEO_MEDIA_EVENT:
        ...
        case SET_SELECTED_PARTICIPANT_INDEX:
        return{
            ...state,
            selectedParticipantIndex : action.selectedParticipantIndex
        }
